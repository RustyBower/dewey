...
from app.api import auth, collections, export_csv, import_csv, items, lending, lookup, refresh, shelf_order, stats, tags, users
...
app.include_router(shelf_order.router, prefix=api_prefix)
